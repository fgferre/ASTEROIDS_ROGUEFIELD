...
### **Problema 1: Sistema de Colisão Ineficiente**
**Localização:** `src/modules/PhysicsSystem.js:274-318`
**Impacto:** FPS cai drasticamente com 50+ objetos
**Solução:** Spatial hashing otimizado

### **Problema 2: Alocações Excessivas no Game Loop**
**Localização:** Múltiplos arquivos
**Impacto:** GC pauses frequentes (5-15ms)
**Solução:** Object pooling system

### **Problema 3: Rendering Ineficiente**
**Localização:** `src/modules/RenderingSystem.js:949-1009`
**Impacto:** Context state changes excessivos
**Solução:** Batch rendering
...
#### **1.1.2 Implementar pools específicos**
**Localização:** `src/core/GamePools.js`
- BulletPool (20 inicial, 50 máximo)
- ParticlePool (100 inicial, 300 máximo)
- AsteroidPool (30 inicial, 80 máximo)
- XPOrbPool (50 inicial, 200 máximo)
...
### **Etapa 1.2: Otimização do Sistema de Colisão** (Dias 3-4)
...
**Implementar:**
- **State caching:** Evitar mudanças desnecessárias
- **Texture reuse:** Cache de gradients e padrões
...
- **FPS:** Mantém 60 FPS com 100+ objetos simultâneos
- **Memory:** <5MB heap crescimento por minuto
- **GC Pauses:** <2ms máximo, <0.5ms médio
- **Load Time:** <200ms para inicialização
...
- [ ] Criar pools específicos (Bullet, Particle, etc.)
...
### **Problemas Comuns**
1. **Pool exhaustion:** Aumentar tamanho inicial ou implementar expansão dinâmica
2. **Spatial hash hotspots:** Ajustar cell size baseado no tamanho médio dos objetos
3. **Render state conflicts:** Verificar ordem de batching
4. **Memory leaks:** Usar WeakMap onde apropriado

### **Rollback Plan**
Se performance targets não forem atingidos:
1. Reverter para main branch
2. Analisar bottlenecks específicos
3. Implementar otimizações pontuais
4. Re-tentar com estratégia modificada

---

**⚠️ Importante:** Manter gameplay e visual 100% idênticos. Performance é invisível ao jogador quando funciona corretamente.

**🎯 Meta:** 20-40% melhoria FPS mantendo qualidade visual e responsividade.