...
- [ ] Verificar colisões entre nave e asteroides com o PhysicsSystem habilitado, garantindo que empurrões, danos e escudo sejam aplicados corretamente mesmo em ondas densas.
