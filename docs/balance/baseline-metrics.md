...
**Status**: ✅ Performance monitoring active, Week 1 polish complete
...
| 2 | Queima Estável | 350 (+25%) | 268 (+22%) | Cyan, +35% length, glow |
| 3 | Injeção Dupla | 406 (+45%) | 304 (+38%) | Electric blue, +60% length |
| 4 | Plasma Superaquecido⚡ | 490 (+75%) | 352 (+60%) | White core, **+100% length** |
| 5 | Sobrecarga Vetorial⚡⚡⚡ | 588 (+110%) | 407 (+85%) | **Plasma white, ion trail (5 DPS)** |

#### 2. Sistema RCS (Maneuvering)
| Rank | Name | Rotation Speed | Angular Damping | Special |
|------|------|----------------|-----------------|---------|
| 0 (Base) | Standard | 8 rad/s (+0%) | 6.2 s⁻¹ (+0%) | - |
| 1 | RCS Básico | 9.2 (+15%) | 6.2 (-0%) | Small puffs |
| 2 | RCS Ativado | 10.6 (+32%) | 5.46 (-12%) | Counter-thrusters |
| 3 | RCS Aprimorado | 12.4 (+55%) | 4.65 (-25%) | Particle trails |
| 4 | RCS Vetorial⚡ | 15.2 (+90%) | 3.72 (-40%) | Vectoring effect |
| 5 | RCS Omni-direcional⚡⚡⚡ | 18.4 (+130%) | 2.79 (-55%) | **Strafe movement unlocked!** |

#### 3. Motores de Freio (Braking)
| Rank | Name | Linear Damping | Special |
|------|------|----------------|---------|
| 0 (Base) | Standard | 3.1 s⁻¹ (+0%) | - |
| 1 | Freios Reforçados | 4.03 (+30%) | Bright counter-thrusters |
| 2 | Reversão Ativa | 4.96 (+60%) | Manual reverse thrust |
| 3 | Parada de Emergência⚡⚡ | 6.2 (+100%) | **Emergency brake + shockwave** |
...
### Reward Formula
```
Orbs Dropped = BaseOrbs × SizeMultiplier × OrbMultiplier
```
...
OrbMultiplier = StatsFactor × RarityBonus
  StatsFactor = HP × Speed × Danger
...
| **DenseCore** | 7% | L:3x M:2x | 2.93 | 44 orbs (220 XP) | 29 orbs (145 XP) | ❌ |
| **Volatile** | 6.5% | L:3x M:2x S:1x | 5.46 | 82 orbs (410 XP)⚡ | 55 orbs (275 XP) | 27 orbs (135 XP) |
| **Parasite** | 4.5% | L:3x M:2x S:1x | 8.10 | 121 orbs (605 XP)⚡⚡ | 81 orbs (405 XP) | 40 orbs (200 XP) |
| **Crystal** | 1.5% | L:3x M:2x S:1x | 4.73 + scaling | 71 orbs (355 XP)💎 | 47 orbs (235 XP) | 24 orbs (120 XP) |
| **Gold** 💰 | **0.4%** | M:2x S:1x | 4.90 | ❌ | 49 orbs (245 XP)💰 | 25 orbs (125 XP) |

**Notes**:
- ⚡ Volatile: High reward compensates for explosion danger
- ⚡⚡ Parasite: Highest reward (pursues player + contact damage)
- 💎 Crystal: Bonus orb every 3 waves (scales infinitely!)
- 💰 Gold: ULTRA-RARE, fast, fragile, special audio feedback
...
| **Crystal** | 0.7x | **1.3x** ⚡ | 0.95x | 1.5% | Agile, scales with waves |
| **Gold** 💰 | **0.4x** | **1.8x** | 0.6x | **0.4%** | Ultra-fragile, ultra-fast, epic audio |
...
GOLD_ASTEROID = {
  ...
  spawnRate: {
    medium: 0.5%,   // 0.02 × 0.25 = 0.005
    small: 0.3%     // 0.02 × 0.15 = 0.003
  },
...
distribution: {
  ...
  gold: 0.00       → ❌ Gold never spawns as Large
  crystal: 0.05    → 1.75% total (rare!)
}
```
...
distribution: {
  ...
  gold: 0.02       → 0.5% total 💰 ULTRA RARE!
  crystal: 0.08    → 2% total (rare)
}
```
...
distribution: {
  ...
  gold: 0.02       → 0.3% total 💰 ULTRA RARE!
  crystal: 0.13    → 1.95% total (rare)
}
```
...
Level 1→2: 100 XP  (20 common small or 2 medium)
Level 2→3: 120 XP
Level 3→4: 144 XP
Level 4→5: 173 XP
Level 5→6: 207 XP
...
- [ ] Does orb fusion (10→1 upgrade) feel satisfying?
...
**Status**: ✅ Performance monitoring active, no degradation observed
...
- ✅ Level up
- ✅ Damage hit
- ✅ **Gold spawn** (arpeggio "bling!")
- ✅ **Gold destroy** (jackpot "ka-ching!")
- ✅ Shield hit
...
**Status**: ✅ Updated with latest game state (orb economy, Gold variant, mobility tree)
